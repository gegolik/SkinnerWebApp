...
export class TratamientoService {
  ...
  */];
  ...
  addTratamiento(trat: tratamientoObject) {
   // return this.http.post("http://localhost:8080/tratamientos",JSON.stringify("{\"id_paciente\":"+idPaciente +",\"id_doctor\":"+ idDoctor+",\"titulo\":"+title+",\"fecha_inicio\":"+startStr+",\"fecha_fin\":"+ endStr+"}"),httpOptions);
  }
